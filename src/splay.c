...
static enum splay_dir splay_nav_to_min(const struct splay_link *arg, const struct splay_link *tree_node)
{
	(void)arg;
	if (tree_node->child[SPLAY_LEFT] == NULL)
		return SPLAY_HERE;
	else
		return SPLAY_LEFT;
}
